...
const BramSVG: React.FC<BramSVGProps> = ({ status, mousePos }) => {
  ...
  const isNaked = status === 'naked';
  const isWarm = status === 'yes' || status === 'naked';
  ...
  return (
    ...
    >
      ...
      <path 
        ...
        fill={isNaked ? skinColor : status === 'yes' ? "white" : status === 'almost' ? "#f5f5f5" : "#eee"} 
        stroke="black" 
        strokeWidth="4" 
      ...
      {isNaked ? (
        <>
          <path d="M100 240 L 145 240 L 145 290 L 100 290 Z" fill={skinColor} stroke="black" strokeWidth="4" className="transition-all duration-500" />
          <path d="M155 240 L 200 240 L 200 290 L 155 290 Z" fill={skinColor} stroke="black" strokeWidth="4" className="transition-all duration-500" />
